...
import 'package:flutty_tut/pages/code_preview_page.dart';
      ...
      body: Padding(
          ...
          child: (ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  GestureDetector(
                    onTap: () {
                      Get.to(CodePreviewPage(title: cardItems[index].name, pageWidget: cardItems[index].preview, codeOfItem: cardItems[index].code, doc: cardItems[index].doc,));
                    },
                    child: WidgetCard(name: cardItems[index].name,
